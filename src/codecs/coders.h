...
enum {
    ...
    METATAG_ENCODER,
    METATAG_TRACKLENGTH,
    METATAG_MUSICBRAINZ_ALBUM_ARTIST_ID,
    METATAG_MUSICBRAINZ_ALBUM_ID,
    METATAG_MUSICBRAINZ_RELEASE_COUNTRY,
    METATAG_MUSICBRAINZ_ALBUM_STATUS,
    METATAG_MUSICBRAINZ_ALBUM_TYPE,
    METATAG_MUSICBRAINZ_ARTIST_ID,
    METATAG_MUSICBRAINZ_RELEASE_GROUP_ID,
    METATAG_MUSICBRAINZ_TRACK_ID,
    METATAG_REPLAYGAIN_REFERENCE_LOUDNESS,
    METATAG_REPLAYGAIN_ALBUM_GAIN,
    METATAG_REPLAYGAIN_ALBUM_PEAK,
    METATAG_REPLAYGAIN_TRACK_GAIN,
    METATAG_REPLAYGAIN_TRACK_PEAK,
