...
const Mp3Encoder::meta_map_t Mp3Encoder::metatag_map {
    ...
    {METATAG_REPLAYGAIN_REFERENCE_LOUDNESS, "TXXX:REPLAYGAIN_REFERENCE_LOUDNESS"},
    {METATAG_REPLAYGAIN_ALBUM_GAIN, "TXXX:REPLAYGAIN_ALBUM_GAIN"},
    {METATAG_REPLAYGAIN_ALBUM_PEAK, "TXXX:REPLAYGAIN_ALBUM_PEAK"},
    {METATAG_REPLAYGAIN_TRACK_GAIN, "TXXX:REPLAYGAIN_TRACK_GAIN"},
    {METATAG_REPLAYGAIN_TRACK_PEAK, "TXXX:REPLAYGAIN_TRACK_PEAK"},
};
